...
# install which lynx w3n for start apache2
RUN zypper -n in which lynx w3m

# add a file which is needed in /etc/apache2/httpd.conf
...
CMD ["/usr/sbin/apache2ctl","start","-DFOREGROUND"]
